...
.mode column
.print
.width 10 19 4 10 28 7 7 7 7 6 6 35
.print
.print == Show Active Rules ==
-- SELECT * 
SELECT testers.Name as who, functions.Name as Function, rules.id as Rule, endpoints.name as EndPoint, methods.name as Method,

...
duration	Defines a time interval	PnYnMnDTnHnMnS
	...
	private static void testEnum() {
		System.out.println("High = " + com.essence.ui.client.object.SeverityTypeDTO.valueOf("HIGH"));
		...
		com.essence.ui.client.object.SeverityTypeDTO t = null;
		try {
			t = com.essence.ui.client.object.SeverityTypeDTO.valueOf("invalid");			
		} catch (Exception ex) {

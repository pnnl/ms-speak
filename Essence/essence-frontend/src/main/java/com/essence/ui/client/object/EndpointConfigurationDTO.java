...
public class EndpointConfigurationDTO implements Serializable, Comparable<EndpointConfigurationDTO> {
	...
	@EmbeddedId    
	protected EndpointConfigurationKeyDTO key;
	...
	public EndpointConfigurationKeyDTO getKey() {
		return key;
	}

	public void setKey(EndpointConfigurationKeyDTO key) {
		this.key = key;
	}
	...
	public int compareTo(EndpointConfigurationDTO o) {
    ...
    public static class Comparators {
        ...
        public static Comparator<EndpointConfigurationDTO> HOST_IP_ADDRESS = new Comparator<EndpointConfigurationDTO>() {
            public int compare(EndpointConfigurationDTO o1, EndpointConfigurationDTO o2) {
	...
	public EndpointConfigurationDTO(EndpointConfigurationKeyDTO key, String hostName, String endpointList, String version) {
		this.key = key;
		this.hostName = hostName;
		this.endpointList = endpointList;
		this.version = version;
